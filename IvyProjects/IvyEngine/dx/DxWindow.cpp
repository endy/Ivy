...
*
*   @brief
*       A static method used for instantiation of DxWindow
*   @return
*       A pointer to a newly created DxWindow instance
***************************************************************************************************
*/
DxWindow* DxWindow::Create(UINT clientWidth, UINT clientHeight)
{
    DxWindow* pNewWindow = new DxWindow();
